...
public class SealUtil {
     ...
     * @throws Exception 异常
     */
    public static void buildAndStoreSeal(SealConfig conf, String fullPath) throws Exception {
     ...
     * @throws Exception 异常
     */
    public static BufferedImage buildSeal(SealConfig conf) throws Exception {
