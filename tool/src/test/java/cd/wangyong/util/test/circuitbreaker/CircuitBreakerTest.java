package cd.wangyong.util.test.circuitbreaker;
...
import cd.wangyong.util.circuitbreaker.CircuitBreaker;
import cd.wangyong.util.circuitbreaker.DefaultCircuitBreaker;
import cd.wangyong.util.circuitbreaker.InterfaceCBConfig;
